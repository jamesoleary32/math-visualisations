...
export default {
  ...
  steps: [
    ...
    },
    {
      ...
      notes: "The radial equation (4.7-2): r̈ − rθ̇² = −K/r²\nThe term rθ̇² is the centripetal acceleration — it appears because polar coordinates are non-inertial.\n\nThe transverse equation (4.7-3): rθ̈ + 2ṙθ̇ = 0\nThis is exactly (1/r)·d/dt(r²θ̇) = 0.\n\nSince F_θ = 0 for any central force, the transverse equation gives d/dt(r²θ̇) = 0 — r²θ̇ is constant.\n\nGreen arrow = θ̂ (transverse).  Red arrow = r̂ (radial outward).",
      setup(c2d, state) {
        Object.assign(state, mkInitState());
        clearControls(state);
        c2d.addGrid({ spacing: 1, color: '#f0f0f0' });
